...
<head>
    ...
    <link href="/tpshop/Public/Home/css/index.css" rel="stylesheet" type="text/css" media="screen"
    />
    <link href="/tpshop/Public/Home/css/style.css" rel="stylesheet" type="text/css" />
...
<body>
        ...
        <div class="logo">
            <a href="#">
                <img src="/tpshop/Public/Home/images/logo.gif">
            </a>
        </div>
        <div class="header_intro">
            <img src="/tpshop/Public/Home/images/by_top.gif">
        </div>
        <div class="headerdg">
            <em>
                抢购热线（全天24小时）
            ...
            <p>
                <img src="/tpshop/Public/Home/images/tel1.gif">
            </p>
        </div>
    </div>
    <div id="nav">
    ...
    <div class="nav_min_div" id="min_div">
        <img src="/tpshop/Public/Home/images/top_min.jpg">
    </div>
    <div id="body">
        <div class="body_l">
            <div class="subsearch">
            ...
            <div class="subnav">
                <?php if(is_array($cats)): foreach($cats as $key=>$c): if($c['parent_id'] == 0): ?><div>
                    ...
                    <span class="right subnav_right">
                        <img src="/tpshop/Public/Home/images/line.gif" border="0" id="categorie_ico1">
                    </span>
                </div>
                <ul>
                    <?php if(is_array($cats)): foreach($cats as $key=>$d): if($d['parent_id'] == $c[cat_id]): ?><li>
                        &nbsp;
                        <a href="<?php echo U('Home/Index/cat',array('cat_id'=>$d['cat_id']));?>">
                            <?php echo ($d["cat_name"]); ?>
                        </a>
            ...
            <div class="subinfo_body_top10">
                <ul>
                    <?php if(is_array($history)): foreach($history as $key=>$g): ?><li>
                        <div class="subinfo_body_top10_l">
                            <a href="#">
                                <img src="/tpshop/Public/upload/<?php echo ($g["thumb_img"]); ?>" alt=""
                                class="samllimg" />
                            </a>
                        </div>
            ...
            <div class="submessage_body">
                <a href="#" target="_blank">
                    <img src="/tpshop/Public/Home/images/message.gif">
                </a>
            </div>
            <div class="subinfo_footer">
            </div>
        ...
        <div class="body_r" style=" display:inline">
            <div class="mainbig">
                <img src="/tpshop/Public/Home/images/banner.jpg" />
            </div>
            <div class="clear">
            </div>
            ...
            <ul class="productlist">
                <?php if(is_array($best)): foreach($best as $key=>$g): ?><li>
                    <a href="<?php echo U('Home/Index/goods' , array('goods_id'=>$g['goods_id']));?>">
                        <img src="/tpshop/Public/upload/<?php echo ($g["thumb_img"]); ?>" alt="<?php echo ($g["goods_name"]); ?>" />
                    </a>
                    <p class="pname">
                        <a href="<?php echo U('Home/Index/goods' , array('goods_id'=>$g['goods_id']));?>" title="<?php echo ($g["goods_name"]); ?>">
                            <?php echo ($g["goods_name"]); echo ($g["goods_brief"]); ?>
                        </a>
                    </p>
                    <p class="price">
                        ￥<?php echo ($g["shop_price"]); ?>元
            ...
            <ul class="productlist">
                <?php if(is_array($new)): foreach($new as $key=>$g): ?><li>
                    <a href="<?php echo U('Home/Index/goods' , array('goods_id'=>$g['goods_id']));?>">
                        <img src="/tpshop/Public/upload/<?php echo ($g["thumb_img"]); ?>" alt="<?php echo ($g["goods_name"]); ?>" />
                    </a>
                    <p class="pname">
    ...
    <div class="footert">
        <div class="footertl">
            <div class="footert_1">
                <img src="/tpshop/Public/Home/images/logo21.gif">
            </div>
            <div class="footert_2">
                抢购热线（9:00-18:00）
                <p>
                    <img src="/tpshop/Public/Home/images/tel2.gif">
                </p>
            </div>
        </div>
        <div class="footertr">
