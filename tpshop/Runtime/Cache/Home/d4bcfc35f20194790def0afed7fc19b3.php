...
<img src="/Public/Home/images/top_min.jpg"></div>
	...
	<div class="mainot">
		...
		<div class="regm">
			...
			<div class="logregmain">
					<form name="formUser" action="/index.php/Home/User/zhuce" method="post">
					<div class="logregline">
						<div class="logreg_l">请填写您的用户名：</div>
						<div class="logreg_r">

							<input name="username" id="username" maxlength="100" type="text" class="input">
						</div>
						<div class="clear"></div>
					</div>
                    ...
                    <div class="logregline">
						...
						<div class="logreg_r">
							...
							<input type="text" name="email" id="email" class="input" maxlength="16">
						</div>
						<div class="clear"></div>
					</div>
					...
					<div class="logregline">
						...
						<div class="logreg_r">
							...
							<input type="password" name="password" id="pwd" class="input" maxlength="16">
						</div>
						<div class="clear"></div>
					</div>
					...
					<div class="logregline">
						...
						<div class="logreg_r">
							...
							<input type="password" name="rpwd" id="rpwd" class="input" maxlength="16">
							<p><span id="password_notice">密码请设为6-16位字母或数字</span></p>
						</div>
						<div class="clear"></div>
					</div>
                    <div class="logregline">
						<div class="logreg_l">输入验证码</div>
						<div class="logreg_r">

							<input type="text" name="vcode" id="rpwd" class="input" maxlength="16">
							<span id="password_notice"><img src="<?php echo U('Home/User/vcode');?>" /></span>
						</div>
						<div class="clear"></div>
					</div>
					<div class="logreg_dl">
					<input name="agreement" value="1" checked="checked" type="hidden" />
