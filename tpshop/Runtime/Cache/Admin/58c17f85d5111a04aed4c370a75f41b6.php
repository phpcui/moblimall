...
<h1>
<span class="action-span"><a href="<?php echo U('admin/Goods/lists');?>">商品列表</a></span>
        ...
        <table width="90%" id="general-table" align="center">
          ...
          <tr>
            ...
            <select name="cat_id"  >
                ...
                <?php if(is_array($cats)): foreach($cats as $key=>$c): ?><option value="<?php echo ($c["cat_id"]); ?>"><?php echo (str_repeat("&nbsp;" ,$c["lev"])); echo ($c["cat_name"]); ?></option><?php endforeach; endif; ?>
            </select>
             </td>
          </tr>
                   <tr>
