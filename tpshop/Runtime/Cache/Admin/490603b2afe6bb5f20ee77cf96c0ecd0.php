...
<table cellpadding="3" cellspacing="1">
  ...
  <tr>
    <?php if(is_array($goods)): foreach($goods as $key=>$g): ?><tr>
      ...
      <td align="right"><span ><?php echo ($g["shop_price"]); ?></span>
    </td>
    ...
    <td align="center"><span >100</span></td>
      ...
      <a href="<?php echo U('Admin/Goods/del' , array('goods_id'=>$g[goods_id]));?>"  title="回收站"><img src="/Public/Admin/images/icon_trash.gif" width="16" height="16" border="0" /></a>
