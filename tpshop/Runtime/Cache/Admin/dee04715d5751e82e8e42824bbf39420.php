...
<table width="100%" cellspacing="1" cellpadding="2" id="list-table">
  ...
  <?php if(is_array($cats)): foreach($cats as $key=>$c): ?><tr align="center" class="0" id="0_1" id = 'tr_1'>
    <td align="left" class="first-cell">
            <img src="/Public/Admin/images/menu_minus.gif" id="icon_0_1" width="9" height="9" border="0" style="margin-left:<?php echo ($c["lev"]); ?>em" />

            <span><a href="#" ><?php echo ($c["cat_name"]); ?></a></span>
        </td>
    <td width="10%">0</td>
